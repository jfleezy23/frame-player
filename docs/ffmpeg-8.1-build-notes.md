...
For the current `v1.5.0` release, use `docs\release-v1.5.0-ab-loop.md` as the maintainer-facing product summary and keep this file as the runtime/build provenance source of truth.
