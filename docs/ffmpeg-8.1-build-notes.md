...
For the current `v1.4.1` GPU release candidate, use `docs\gpu-vulkan-phase1-release.md` as the maintainer-facing product summary and keep this file as the runtime/build provenance source of truth.
