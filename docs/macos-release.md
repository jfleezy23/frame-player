...
```bash
PACKAGE_VERSION=2.1.0-rc.14 script/validate_macos_release_candidate.sh --corpus "Video Test Files"
```
...
```bash
PACKAGE_VERSION=2.1.0-rc.14 script/package_unified_macos_release.sh --sign
