...
- The current release line is the custom-FFmpeg-only `1.1.0` build; older FFME-era releases are legacy/deprecated and should only be used for historical comparison.
