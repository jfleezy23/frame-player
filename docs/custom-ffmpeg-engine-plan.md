...
This is a historical planning checkpoint kept for project history. It predates the active `v1.4.3` GPU release. For current shipped behavior, see `docs\gpu-vulkan-phase1-release.md` and `docs\ffmpeg-8.1-build-notes.md`.
