...
namespace FramePlayer.Services
{
    ...
    /// </summary>
    /// <remarks>
    /// This keeps heavy FFmpeg export work outside the interactive application process while avoiding any
    ...
    internal sealed class ExportHostClient
    {
        ...
        internal const string AppBaseDirectoryEnvironmentVariable = "FRAMEPLAYER_AVALONIA_APP_BASE_DIRECTORY";
        ...
        {
            var explicitExecutablePath = Environment.GetEnvironmentVariable(ExportHostExecutableEnvironmentVariable);
        ...
        {
            var appBaseDirectory = Environment.GetEnvironmentVariable(AppBaseDirectoryEnvironmentVariable);
