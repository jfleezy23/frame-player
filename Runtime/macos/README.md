...
The current preview package is Apple Silicon focused because only an `osx-arm64` FFmpeg runtime has been staged. A universal or Intel-compatible release requires a pinned `osx-x64` macOS runtime with matching provenance and validation.
