...
| Beta | macOS Intel x64 | `v2.1.1-beta.1` | [FramePlayer-macOS-x64-2.1.1-beta.1.zip](https://github.com/jfleezy23/frame-player/releases/download/v2.1.1-beta.1/FramePlayer-macOS-x64-2.1.1-beta.1.zip) |
