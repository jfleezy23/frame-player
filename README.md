...
- `Ctrl+N` opens a blank new Frame Player window
...
- Current release note: [docs/release-v1.8.3-feedback.md](docs/release-v1.8.3-feedback.md)
...
- The current release note is `docs\release-v1.8.3-feedback.md`
