...
namespace FramePlayer.Avalonia.Tests
{
    public sealed class MacExportReleaseCandidateTests : IClassFixture<AvaloniaHeadlessFixture>
    {
        ...
        public async Task MacWindow_ExportsLoopClipCompareDiagnosticsAndAudioInsertion()
        {
            ...
            var previousExportHostExecutable = Environment.GetEnvironmentVariable(ExportHostClient.ExportHostExecutableEnvironmentVariable);
            ...
            finally
            {
                ...
                Environment.SetEnvironmentVariable(ExportHostClient.ExportHostExecutableEnvironmentVariable, previousExportHostExecutable);
            }
        }
        ...
        private static void ConfigureRuntime()
        {
            ...
            var testOutputExportHost = Path.Combine(AppContext.BaseDirectory, "FramePlayer.Avalonia");
            Environment.SetEnvironmentVariable(
                ExportHostClient.AppRuntimeBaseEnvironmentVariable,
                runtimeBaseDirectory);
            if (string.IsNullOrWhiteSpace(Environment.GetEnvironmentVariable(
                    ExportHostClient.ExportHostExecutableEnvironmentVariable)) &&
                File.Exists(testOutputExportHost))
            {
                Environment.SetEnvironmentVariable(
                    ExportHostClient.ExportHostExecutableEnvironmentVariable,
