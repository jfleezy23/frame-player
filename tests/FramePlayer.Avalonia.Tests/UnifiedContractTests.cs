...
namespace FramePlayer.Avalonia.Tests
{
    public sealed class UnifiedContractTests : IClassFixture<AvaloniaHeadlessFixture>
    {
        ...
        {
            const string version = "2.1.0-rc.14";
            const string windowsAsset = "FramePlayer-Windows-x64-2.1.0-rc.14.zip";
            const string macAsset = "FramePlayer-macOS-arm64-2.1.0-rc.14.zip";
        ...
        public void UnifiedWindowsPackage_PassesPackageVersionIntoAssemblyMetadata()
        {
            ...
            Assert.Contains("[string]$Version = \"2.1.0-rc.14\"", script, StringComparison.Ordinal);
            ...
            Assert.Contains("$packageVersion = \"2.1.0-rc.14\"", workflow, StringComparison.Ordinal);
        }
        ...
        public void UnifiedMacPackage_DerivesBundleVersionFromReleaseCandidateLabel()
        {
            ...
            Assert.Contains("ARTIFACT_VERSION=\"${PACKAGE_VERSION:-${VERSION:-2.1.0-rc.14}}\"", script, StringComparison.Ordinal);
            ...
            Assert.Contains("PACKAGE_VERSION=2.1.0-rc.14", workflow, StringComparison.Ordinal);
